...
* GPUs are now automatically read from pci id database online and offline as a fallback. ([4e3cb05](https://github.com/exalsius/client-hw-info/commit/4e3cb058d90f2439f4b8d2f898eeb7dbdb898832))
